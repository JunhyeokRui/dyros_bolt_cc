...
def run(config):
    ...
    if network_type == "LSTM":
        ...
        print('A2C is used')
        nn_training = CustomA2C(config, checkpoint_directory)
    ...
    # file_name = os.path.join("./checkpoints/", play_model)
    ...
    #     name= name.replace(".","_")
    #     weight_file_name = "./weight/" + name + ".txt"
